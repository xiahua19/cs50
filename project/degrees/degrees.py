...
# Maps person names to a set of corresponding person_ids
names = {}
...
def shortest_path(source, target):
    ...
    # Initialize a queuefrontier, add the sorceNode to it
    ...
    while True:
        ...
        # if node state is target, we have found the solution
        ...
        # get the node's neighbors and add them to frontier
